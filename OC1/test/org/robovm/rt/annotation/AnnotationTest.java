...
public class AnnotationTest {
    ...
    @Anno4(
            ...
            ints1 = {2000000002, 2000000001, 2000000000},
            longs1 = {20000000002L, 20000000001L, 20000000000L},
    ...
    public void testAnnotationMembersWithoutDefaults() {
        ...
        assertEquals(2000000001, anno.int1());
        assertEquals(20000000001L, anno.long1());
        ...
        assertArrayEquals(new int[] {2000000002, 2000000001, 2000000000}, anno.ints1());
        assertArrayEquals(new long[] {20000000002L, 20000000001L, 20000000000L}, anno.longs1());
    ...
    public void testAnnotationMemberDefaults() {
        ...
        assertEquals(2000000000, anno.int2());
        assertEquals(20000000000L, anno.long2());
        ...
        assertArrayEquals(new int[] {2000000000, 2000000001, 2000000002}, anno.ints2());
        assertArrayEquals(new long[] {20000000000L, 20000000001L, 20000000002L}, anno.longs2());
